...
hello = Lesson.create!(title: 'Hello', audio:'https://www.youtube.com/watch?v=dJ2AiodDhNI', question:'hello', answer:'ciao', user:olee, language:italian)
...
hello = Lesson.create!(title: 'Hello', audio:'https://www.youtube.com/watch?v=7mkC29XFyVo', question:'hello', answer:'你好', user:olee, language:chinese)